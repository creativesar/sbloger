...
const Page: React.FC<{ postId: number; imageSrc: string; title: string; content: string; tips: string[]; conclusion: string; }> = ({ postId, imageSrc, title, content, tips, conclusion }) => {
